...
1. Ethereum smart contract and DSB (Disk Storage Banking) distributive storage 
2. secure computing technologies to contribute public computing power to Berkeley Open Infrastructure for Network Computing (BOINC) and other scientific computing platforms
3. adopting a new PoW+DSB PoS consensus mechanism
